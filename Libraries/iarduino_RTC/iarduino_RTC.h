...
class iarduino_RTC{
	...
	/**	пользовательские функции **/
		iarduino_RTC(uint8_t);	//	подключение (название [, вывод SS/RST [, вывод CLK [, вывод DAT]]])
	...
	private:
	/**	параметры модулей **/
		uint8_t	RTC_uint_MODULE			=	1;						//	чип модуля RTC (по умолчанию = RTC_UNDEFINED)
		int16_t	RTC_array_BUS[8]		=	{RTC_I2C,  100, 0x68, 0, 0, 0, 0, 0};
		uint16_t	RTC_array_STR[11] = { 3,0x02,0b0010000000000000,0x0E,0b1010001010101010,0x0F,0b1000000011001010 };
		uint8_t	RTC_array_REG[7] = { 0x00,0x01,0x02,0x04,0x05,0x06,0x03};
		uint8_t	RTC_ignor_BIT[7] = { 0x7F,0x7F,0x3F,0x3F,0x1F,0xFF,0x07};
